...
apple_picking = Activity.create(:activity_name => "apple picking", :comment => "blablabla", :traveller_id => mary.id, :trip_id => nyc.id)
shopping = Activity.create(:activity_name => "shopping", :comment => "I will come back for sure", :traveller_id => mary.id, :trip_id => moscou.id)
...
kayak = Activity.create(:activity_name => " kayak", :comment => "Gimme more of kayak there", :traveller_id => john.id, :trip_id => lima.id)
